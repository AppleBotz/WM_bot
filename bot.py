...
async def HelpWatermark(bot, cmd):
	...
	await cmd.reply_text(
		...
		parse_mode="Markdown",
		reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/blvckcards"), InlineKeyboardButton("Support Group", url="https://t.me/SharkUserbot")], [InlineKeyboardButton("Bots Channel", url="https://t.me/Blvckcards")], [InlineKeyboardButton("Source Code", url="https:/t.me/blvckcards")]]),
...
async def VidWatermarkAdder(bot, cmd):
	...
	output_vid = main_file_name + "_[" + str(cmd.from_user.id) + "]_[" + str(time.time()) + "]_[@BLVCKCARDS]" + ".mp4"
...
async def button(bot, cmd: CallbackQuery):
	...
	if "refreshmeh" in cb_data:
			...
			try:
				...
				if user.status == "kicked":
					await cmd.message.edit(
						text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/SharkUserbot).",
						parse_mode="markdown",
						disable_web_page_preview=True
					)
					return
		...
		await cmd.message.edit(
			text=Config.USAGE_WATERMARK_ADDER,
			parse_mode="Markdown",
			reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("Developer", url="https://t.me/Blvckcards"), InlineKeyboardButton("Support Group", url="https://t.me/SharkUserbot")], [InlineKeyboardButton("Bots Channel", url="https://t.me/Blvckcards")]]),
			disable_web_page_preview=True
		)
